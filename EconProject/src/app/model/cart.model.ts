...
export class Cart {
  ...
  public cartDiscountPrice: number = 0;
  public cartNetPrice: number = 0;
  ...
  private recalculate() {
    ...
    this.lines.forEach((l) => {
      ...
      this.cartDiscountPrice = this.cartPrice * 0.1;
      this.cartNetPrice = this.cartPrice - this.cartDiscountPrice;
    });
  }
}
